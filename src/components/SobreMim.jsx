...
function SobreMim() {
  return (
    ...
    <div className='conteudo_container' id='sobre'>
                ...
                <CardProfissional
                titulo='Meu lado pessoal'
                conteudo='Um jovem de 21 anos, morador de Marialva-PR, estudante (4º Período de A.D.S), cristão e tecladista.
                Fora essasatribuições, sou apaixonado pelas coisas simples, gosto de fazer um caminhada ouvindo música e ver o por sol, ouço música classica as vezes e toco violino, gosto de ler e escrever também! Tenho um pré-projeto ciêntifico e um livro, de suspense quem estão em desenvolvimento.
                Com 6 meses trabalhando na área, fui responsável por atualizar o design do site  em React da Minus, tenho experiência Front end com projetos e tratamento de responsividade, trabalhando com modelos no figma, e metodologia Kanban. '
                />
